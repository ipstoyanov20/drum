	...
	return (
		<main className="flex min-h-screen flex-col items-center overflow-x-hidden">
				...
				<div className="flex-col lg:flex-row-reverse">
					...
					<div className="grid place-items-center place-content-start w-full">
						...
						<div className="grid grid-col-1 grid-rows-2 sm:grid-cols-2 gap-0">
							<button className="ml-0 relative after:content-[''] after:top-0 after:left-0 after:absolute after:w-full after:h-full after:shadow-lg w-96 sm:w-36 from-ex:max-to-ex:ml-2 from-ex:max-to-ex:w-80 h-10 shadow-inner-top grid place-content-center shadow-white rounded-sm px-4 py-3 mb-0 sm:m-3 bg-[#B59861] text-[#f3ecdd] font-bold font-grotesk ">
								ORDER
							</button>
							<button className="ml-0 whitespace-nowrap  relative after:content-[''] after:top-0 after:left-0 after:absolute after:w-full after:h-full after:shadow-lg w-96 from-ex:max-to-ex:ml-2 from-ex:max-to-ex:w-80 sm:w-36 h-10 shadow-inner-top grid place-content-center shadow-white border border-[#B59861] rounded-sm px-4 py-3 mt-3 sm:m-3 bg-transparent text-[#B59861] font-bold font-grotesk ">
								SEE INTERVIEWS
							</button>
						</div>
					</div>
			...
			<div className="hero bg-background min-h-screen">
				<div className="w-screen h-screen px-10 py-0 flex-col lg:flex-row mt-[-40%] sm:mt-0">
					...
					<section className="from-ex:max-to-ex:mt-[-150%]  mt-[-60%] sm:mt-0 grid place-items-center place-content-center md:max-lg:grid-cols-2 grid-cols-1 sm:grid-cols-6 gap-3 gap-y-5 ml-2 sm:-ml-4 translate-y-[30%]">
			...
			<div className="w-screen h-screen p-10 from-ex:max-to-ex:mt-[250%] mt-[140%] sm:mt-0 sm:mb-[40%]">
				...
				<div className="grid place-content-center place-items-center from-ex:max-to-ex:translate-y-[0%] translate-y-[30%]">
					<ul className="grid place-items-center place-content-center relative grid-cols-2 gap-x-48">
						<img
							src={blobImg.src}
							className="absolute from-ex:max-to-ex:translate-x-[-40%] from-ex:max-to-ex:translate-y-[-120%] translate-x-[-40%] translate-y-[-50%] sm:translate-x-[-130%] sm:translate-y-[-70%] scale-50"
							alt=""
						/>
						<img
							src={blobImg.src}
							className="absolute from-ex:max-to-ex:translate-x-[50%] from-ex:max-to-ex:translate-y-[-20%] translate-x-[40%] translate-y-[-160%] sm:translate-x-[-20%] sm:translate-y-[70%] scale-50"
							alt=""
						/>
						<div className="ml-[350%] mt-[-600%] from-ex:max-to-ex:ml-[600%] from-ex:max-to-ex:mt-[-600%]  from-ex:max-to-ex:scale-[40%] sm:ml-0 sm:mt-0 scale-50 sm:scale-100 z-0 shadow-bottom w-[600px] h-[500px] relative rounded-t-[5%] rounded-b-[5%] border-2 overflow-hidden border-black ">
							<span
								style={{
						...
						<div className="grid grid-cols-2 grid-rows-2 sm:grid-rows-4 sm:grid-cols-1 ml-[-450%] from-ex:max-to-ex:ml-[-750%] sm:ml-0 from-ex:max-to-ex:translate-y-[30%]  translate-y-[25%] sm:translate-y-0 from-ex:max-to-ex:scale-[50%] scale-[60%] sm:scale-100 gap-x-48 sm:gap-x-0">
							{items.map((item, index) => (
								<li
									key={item.id}
