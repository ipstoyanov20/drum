		...
		<main className="flex min-h-screen flex-col items-center overflow-hidden">
			<div className="hero grid place-items-start place-content-center bg-background min-h-screen mt-[-30%] sm:mt-0">
				<div className="flex-col lg:flex-row-reverse">
					...
					<div className="grid place-items-center place-content-start w-full">
						...
						<h1 className="z-[10] text-7xl  font-bold sm:font-bold text-left font-grotesk m-5 sm:text-center sm:text-9xl">
							My Rythm <br /> Your favourite song
						</h1>
						<p className="m-5 grid place-content-center text-left sm:text-center text-lg text-[#B59861] sm:text-base">
			...
			<div className="hero bg-background min-h-screen">
				<div className="w-screen h-screen px-10 py-0 flex-col lg:flex-row mt-[-40%] sm:mt-0">
					<h1 className="font-grotesk font-bold text-7xl sm:text-9xl text-center">
						<span className="text-[#B59861] m-0">GENRES</span> <br /> I PLAY
					</h1>
					<section className="mt-[-60%] sm:mt-0 grid place-items-center place-content-center grid-cols-1 sm:grid-cols-6 gap-3 gap-y-5 ml-2 sm:-ml-4 translate-y-[30%]">
						<div className="shadow-bottom col-span-2 shadow-black border-2 border-black rounded-lg">
							<h1 className="text-3xl sm:text-5xl font-bold font-grotesk text-left p-3 flex flex-row justify-between items-center">
								BG FOLK
								<img
									src="bg-flag.jpg"
						...
						<div className="shadow-bottom col-span-2 sm:col-span-3 shadow-black border-2 border-black rounded-lg">
							<h1 className="text-3xl sm:text-5xl font-bold font-grotesk text-left p-3 flex flex-row justify-between items-center">
								REGGAETON
						...
						<div className="shadow-bottom shadow-black border-2 col-span-2 sm:col-span-3 border-black rounded-lg">
							<h1 className="text-3xl sm:text-5xl font-bold font-grotesk text-left p-3 flex flex-row justify-between items-center">
								RAP
			...
			<div className="w-screen h-screen p-10 mt-[150%] sm:mt-0 sm:mb-[40%]">
				<h1 className="font-grotesk font-bold text-7xl sm:text-9xl text-center">
					HOW IT <br /> WORKS?
				</h1>
				<div className="grid place-content-center place-items-center translate-y-[30%]">
					<ul className="grid place-items-center place-content-center relative grid-cols-2 gap-x-48">
						<img
							src={blobImg.src}
							className="absolute translate-x-[-40%] translate-y-[-50%] sm:translate-x-[-130%] sm:translate-y-[-70%] scale-50"
							alt=""
						/>
						<img
							src={blobImg.src}
							className="absolute translate-x-[40%] translate-y-[-160%] sm:translate-x-[-20%] sm:translate-y-[70%] scale-50"
							alt=""
						/>
						<div className="ml-[350%] mt-[-600%] sm:ml-0 sm:mt-0 scale-50 sm:scale-100 z-0 shadow-bottom w-[600px] h-[500px] relative rounded-t-[5%] rounded-b-[5%] border-2 overflow-hidden border-black ">
							<span
								style={{
						...
						<div className="grid grid-cols-2 grid-rows-2 sm:grid-rows-4 sm:grid-cols-1 ml-[-450%] sm:ml-0 translate-y-[25%] sm:translate-y-0 scale-[60%] sm:scale-100 gap-x-48 sm:gap-x-0">
							{items.map((item, index) => (
								<li
									key={item.id}
